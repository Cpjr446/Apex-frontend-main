            ...
            >
              ...
              <div className="space-y-3">
                <button
                  ...
                  disabled={isLoading !== ""}
                  className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-lg font-bold transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed shadow-lg hover:scale-[1.02] active:scale-[0.98]"
                  style={{
                ...
                >
                  ...
                  <span>Instant Dev / Guest Login</span>
                </button>

                <div className="relative flex py-2 items-center">
                  <div className="flex-grow border-t border-white/10"></div>
                  <span className="flex-shrink mx-4 text-white/40 text-xs uppercase tracking-widest">Or social login</span>
                  <div className="flex-grow border-t border-white/10"></div>
                </div>
